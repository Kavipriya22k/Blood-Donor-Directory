<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BloodDonationReport.aspx.cs" Inherits="Admin_BloodDonationReport" %>
             ...
             <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center">
                        <h2 class="section-heading">BLOOD DONATION REPORT</h2>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="No. Of Units">
                 ...
                 <asp:TemplateField HeaderText="Donation Date">
                   <ItemTemplate>
                       <asp:Label ID="Label8" runat="server" Text='<%# Eval("donatedate") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
               </asp:TemplateField>
            </Columns>
