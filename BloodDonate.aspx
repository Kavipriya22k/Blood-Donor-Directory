<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BloodDonate.aspx.cs" Inherits="Admin_BloodDonate" %>
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                           <form id="form1" runat="server">
                               ...
                               <div class="searchdiv" style="margin-bottom:50px;">
                                      <asp:TextBox ID="txtDonorName" runat="server" placeholder="Enter Donor Name" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnSearch" CssClass="btn3d" runat="server" Text="Search" OnClick="btnSearch_Click" />
               
                               </div>
                               <div>
                                   <asp:GridView ID="datagrid" runat="server"  AutoGenerateColumns="False" OnRowCommand="get_donorinformation">
    ...
    <HeaderStyle CssClass="GridViewHeaderStyle" />
           ...
           <asp:CommandField ShowSelectButton="True" SelectText="Select" />
                  ...
                  <asp:TemplateField HeaderText="Donor ID">
                   <ItemTemplate>
                       <asp:Label ID="lbldonorid" runat="server" Text='<%# Eval("donorid") %>'></asp:Label>
                   </ItemTemplate>
