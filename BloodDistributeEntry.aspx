<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BloodDistributeEntry.aspx.cs" Inherits="Admin_BloodDistributeEntry" %>
             ...
             <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center">
                        <h2 class="section-heading">NEW ENTRY BLOOD DISTRIBUTION</h2>
                                  ...
                                  <div class="form-group">
                                      <table class="tblstyle">
                                          <tr>
                                              ...
                                              <td>
                                                  <asp:TextBox ID="txtPatientID" CssClass="form-control" runat="server"  required="required"></asp:TextBox>     
                                              </td>
                                          </tr>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <asp:TextBox ID="txtpatientbloodgroup" CssClass="form-control" runat="server"  required="required"></asp:TextBox>     
                                              </td>
                                          </tr>
                                           <tr>
                                              <td style="text-align:right;">
                                              ...
                                              <td>
                                               ...
                                               <td>
                                                   <asp:Label ID="lblerrorunits" runat="server" Text="" style="color:red;"></asp:Label>
                                              </td>
                                          </tr>
                                           <tr>
                                              <td style="text-align:right;">
                                              ...
                                              <td>
                                                   <asp:TextBox ID="txtAmount" CssClass="form-control" runat="server"  placeholder="Enter Amount (NUMBER ONLY)" ></asp:TextBox>      
                                
                                              </td>
                                               <td>
                                                   <asp:Label ID="lblerroramt" runat="server" Text="" style="color:red;"></asp:Label>
                                              </td>
                                          </tr>
